...
const projectsData = [
  ...
  { title: 'Menu Bar Quotes (MacOS)', url: 'https://github.com/bestisblessed/menu-bar-quotes', description: 'Native macOS menu bar app for keeping short quotes visible while the app stays out of the way. Includes quote library management, import/export, style controls, scheduled rotation, and a manual next-quote action.', skills: ['macOS', 'Swift', 'AppKit', 'XCode'], image: menuBarQuotesImage },

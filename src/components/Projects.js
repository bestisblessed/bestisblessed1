...
//  { title: 'Deepseek', url: 'https://github.com/bestisblessed/deepseek', description: 'Python scripts demonstrating Deepseek API interactions for streaming embeddings and data processing with pandas.', skills: ['Python', 'Deepseek API', 'Pandas'] },
  { title: 'MMA-AI Swift App', url: 'https://apps.apple.com/us/app/mma-ai/id6743686924', description: 'SwiftUI-based iOS application providing AI-driven MMA statistics and fight predictions, backed by a Flask/Python API.', skills: ['Swift', 'SwiftUI', 'Flask', 'Python'], image: mmaAiSwiftImage },
  ...
  { title: 'MLB-AI', url: 'https://mlb-ai.streamlit.app/', description: 'Streamlit app for MLB data analysis and prediction, featuring interactive visualizations, machine learning insights, and comprehensive statistical breakdowns for baseball enthusiasts.', skills: ['Python', 'Streamlit', 'AI', 'Data Analysis'], image: mlbAiImage },
...
//  { title: 'Trading Bots (Private)', url: 'https://github.com/bestisblessed/trading-bots-private', description: 'Robust production-grade trading bots for automated cryptocurrency strategies on Solana and Base chains, including risk management and performance monitoring.', skills: ['Shell', 'Blockchain'] },
  { title: 'Oil AI Dashboard', url: 'https://oil-ai-dashboard.streamlit.app/', description: 'Streamlit-based dashboard for oil & gas analytics, featuring interactive charts, machine learning forecasts, and geospatial data visualizations for industry insights.', skills: ['Python', 'Streamlit'], image: oilAiImage }
];

...
import menuBarQuotesImage from '../images/menu-bar-quotes.png'
import polymarketBotsImage from '../images/polymarket-bots.png'
import myBotsDashboardImage from '../images/my-bots-dashboard.svg'
import clawhubProfileImage from '../images/clawhub-profile.png'

const projectsData = [
  { title: 'MMA AI (iOS)', url: 'https://apps.apple.com/us/app/mma-ai/id6743686924', description: 'SwiftUI-based iOS application providing AI-driven MMA statistics and fight predictions, backed by a Flask/Python API.', skills: ['XCode', 'SwiftUI', 'iOS', 'Flask'], image: mmaAiSwiftImage },
  { title: 'MMA AI Dashboard', url: 'https://mma-ai.streamlit.app/', description: 'UFC/MMA data analysis platform with AI report generation and fight prediction capabilities. Built for advanced sports handicappers to analyze fighter statistics, matchup histories, and generate predictive insights.', skills: ['AI', 'Data Analysis', 'Machine Learning', 'Streamlit'], image: mmaAiImage },
  { title: 'MLB AI Dashboard', url: 'https://mlb-ai.streamlit.app/', description: 'MLB data analysis and prediction app featuring interactive visualizations, machine learning insights, and comprehensive statistical breakdowns for baseball enthusiasts.', skills: ['AI', 'Data Analysis', 'Streamlit'], image: mlbAiImage },
  { title: 'NFL AI Dashboard', url: 'https://nfl-ai.streamlit.app/', description: 'NFL data analysis website designed for advanced sports handicappers. Features interactive visualization tools, AI-driven insights, and comprehensive statistical analysis to help users make more informed decisions.', skills: ['AI', 'Data Analysis', 'Streamlit'], image: nflAiImage },
  ...
  { title: 'Menu Bar Quotes (MacOS)', url: 'https://apps.apple.com/us/app/menu-quotes/id6760243199?mt=12', description: 'Native macOS menu bar app for keeping short quotes visible while the app stays out of the way. Includes quote library management, import/export, style controls, scheduled rotation, and a manual next-quote action.', skills: ['macOS', 'Swift', 'AppKit', 'XCode'], image: menuBarQuotesImage },
  { title: 'ClawHub Skills Profile', url: 'https://clawhub.ai/u/bestisblessed', description: 'Public ClawHub profile with 4 published skills, 18 stars, and about 4.1k downloads across Export, Simplify Code, Clip, and Youtube Download.', skills: ['Codex Skills', 'ClawHub', 'Automation', 'Developer Tools'], image: clawhubProfileImage },
  ...
  { title: 'Polymarket Bots', url: 'https://github.com/bestisblessed/polymarket-bots', description: 'Collection of Polymarket utility scripts and working bot examples for automation, trading research, whale monitoring, sports market analytics, and Pushover alerts.', skills: ['Python', 'Polymarket API', 'Bots', 'Trading', 'Pushover'], image: polymarketBotsImage },
  ...
  { title: 'My Bots Dashboard', url: 'https://github.com/bestisblessed/my-bots-dashboard', description: 'Read-only terminal dashboard for monitoring a bot fleet across Tailscale-connected servers. It checks server health, disk usage, cron freshness, recent job status, and key services through SSH.', skills: ['Python', 'SSH', 'Tailscale', 'Cron', 'DevOps'], image: myBotsDashboardImage },

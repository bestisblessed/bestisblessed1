  ...
  return (
    <section id="about" style={styles.section}>
      ...
      <p style={styles.paragraph}>
        I'm a Software / DevOps / AI engineer with over 5 years of professional experience.
        ...
        AI agents and automation templates, and many other data processing pipelines and monitoring systems.
      </p>
